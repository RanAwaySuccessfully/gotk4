...
// extern gchar* _gotk4_glib2_TranslateFunc(gchar*, gpointer);
// extern gboolean _gotk4_glib2_SourceFunc(gpointer);
// extern gboolean _gotk4_glib2_IOFunc(GIOChannel*, GIOCondition, gpointer);
...
// scanning and printing values of type #gint32. See also G_GINT16_FORMAT.
...
// scanning and printing values of type #gint64. See also G_GINT16_FORMAT.
//
...
// scanning and printing values of type #gsize. See also G_GINT16_FORMAT.
...
// scanning and printing values of type #gssize. See also G_GINT16_FORMAT.
...
// scanning and printing values of type #guint16. See also G_GINT16_FORMAT.
const GUINT16_FORMAT = "hu"

// GUINT32_FORMAT: this is the platform dependent conversion specifier for
// scanning and printing values of type #guint32. See also G_GINT16_FORMAT.
const GUINT32_FORMAT = "u"

// GUINT64_FORMAT: this is the platform dependent conversion specifier for
// scanning and printing values of type #guint64. See also G_GINT16_FORMAT.
//
// Some platforms do not support scanning and printing 64-bit integers,
...
// CopyFunc: function of this signature is used to copy the node data when doing
// a deep-copy of a tree.
type CopyFunc func(src unsafe.Pointer) (gpointer unsafe.Pointer)
...
// IOFunc specifies the type of function passed to g_io_add_watch() or
// g_io_add_watch_full(), which is called when the requested condition on a
// OChannel is satisfied.
type IOFunc func(source *IOChannel, condition IOCondition) (ok bool)
...
// NodeForEachFunc specifies the type of function passed to
// g_node_children_foreach(). The function is called with each child node,
// together with the user data passed to g_node_children_foreach().
type NodeForEachFunc func(node *Node)

// NodeTraverseFunc specifies the type of function passed to g_node_traverse().
// The function is called with each of the nodes visited, together with the
// user data passed to g_node_traverse(). If the function returns TRUE, then the
// traversal is stopped.
type NodeTraverseFunc func(node *Node) (ok bool)

// OptionArgFunc: type of function to be passed as callback for
// G_OPTION_ARG_CALLBACK options.
type OptionArgFunc func(optionName, value string) (_goerr error)
...
// TranslateFunc: type of functions which are used to translate user-visible
// strings, for <option>--help</option> output.
type TranslateFunc func(str string) (utf8 string)

// TraverseFunc specifies the type of function passed to g_tree_traverse().
// It is passed the key and value of each node, together with the user_data
// parameter passed to g_tree_traverse(). If the function returns TRUE,
// the traversal is stopped.
type TraverseFunc func(key, value unsafe.Pointer) (ok bool)
...
//
//   - channel: OChannel.
//   - priority of the OChannel source.
//   - condition to watch for.
//   - fn: function to call when the condition is satisfied.
//
// The function returns the following values:
//
//   - guint: event source id.
func IOAddWatch(channel *IOChannel, priority int, condition IOCondition, fn IOFunc) uint {
	var _arg1 *C.GIOChannel  // out
	var _arg2 C.gint         // out
	var _arg3 C.GIOCondition // out
	var _arg4 C.GIOFunc      // out
	...
	_arg3 = C.GIOCondition(condition)
	_arg4 = (*[0]byte)(C._gotk4_glib2_IOFunc)
	_arg5 = C.gpointer(gbox.Assign(fn))
	_arg6 = (C.GDestroyNotify)((*[0]byte)(C.callbackDelete))

	_cret = C.g_io_add_watch_full(_arg1, _arg2, _arg3, _arg4, _arg5, _arg6)
...
// is enabled.
//
// Note that this should not be used to conditionalise calls to g_debug()
// or other logging functions; it should only be used from GLogWriterFunc
// implementations.
//
// Note also that the value of this does not depend on G_MESSAGES_DEBUG; see the
// docs for g_log_set_debug_enabled().
//
// The function returns the following values:
//
...
// LogSetDebugEnabled: enable or disable debug output from the GLib
// logging system for all domains. This value interacts disjunctively with
// G_MESSAGES_DEBUG — if either of them would allow a debug message to be
// outputted, it will be.
//
...
// to the integer passed to exit() or returned from main().
//
// Note that it is invalid to pass G_SPAWN_DO_NOT_REAP_CHILD in flags, and on
// POSIX platforms, the same restrictions as for g_child_watch_source_new()
// apply.
//
...
//     inherit parent's.
//   - argv: child's argument vector, which must be non-empty and
//     NULL-terminated.
...
//   - waitStatus (optional): return location for child wait status, as returned
//     by waitpid(), or NULL.
func SpawnSync(workingDirectory string, argv, envp []string, flags SpawnFlags, childSetup SpawnChildSetupFunc) (standardOutput, standardError []byte, waitStatus int, goerr error) {
	var _arg1 *C.gchar               // out
	var _arg2 **C.gchar              // out
	var _arg3 **C.gchar              // out
...
// DateTime: opaque structure that represents a date and time, including a time
// zone.
//
// An instance of this type is always passed by reference.
...
// are preceded by a figure space
//
...
// digits are preceded by a figure space
//
...
// strings, for --help output. Different groups can use different Funcs. If func
...
func (group *OptionGroup) SetTranslateFunc(fn TranslateFunc) {
	var _arg0 *C.GOptionGroup  // out
	var _arg1 C.GTranslateFunc // out
	var _arg2 C.gpointer
	var _arg3 C.GDestroyNotify

	_arg0 = (*C.GOptionGroup)(gextras.StructNative(unsafe.Pointer(group)))
	if fn != nil {
		_arg1 = (*[0]byte)(C._gotk4_glib2_TranslateFunc)
		_arg2 = C.gpointer(gbox.Assign(fn))
		_arg3 = (C.GDestroyNotify)((*[0]byte)(C.callbackDelete))
	}

	C.g_option_group_set_translate_func(_arg0, _arg1, _arg2, _arg3)
	runtime.KeepAlive(group)
	runtime.KeepAlive(fn)
}
...
// PatternSpec struct is the 'compiled' form of a pattern. This structure is
...
// usually touching only a single memory page. Serialized #GVariant data can
...
// #GVariant's serialization format is not the same as the serialization format
...
// memory for serialized data, memory for the type information cache, buffer
...
// calls. For example, if a #GVariant is constructed out of serialized data
